 ...
 * temporary list variable is assigned to our static list variable *
 ...
 * in a temporary char pointer and strdup the the point we reached *
 * into the list content, subsequently freeing the pointer we just *
